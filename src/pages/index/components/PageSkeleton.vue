<template name="skeleton">
  <view is="components/WaterProductSwiper">
    <view class="carousel WaterProductSwiper--carousel">
      <swiper :circular="true" :interval="3000" :current="0" :autoplay="false">
        <swiper-item
          ...
          "
        >
          <navigator class="navigator WaterProductSwiper--navigator" hover-class="none">
            <image class="image WaterProductSwiper--image sk-image" mode="aspectFill"></image>
          </navigator>
        </swiper-item>
      </swiper>
      <view class="indicator WaterProductSwiper--indicator">
        <text class="dot WaterProductSwiper--dot active WaterProductSwiper--active"></text>
        <text class="dot WaterProductSwiper--dot"></text>
        <text class="dot WaterProductSwiper--dot"></text>
        <text class="dot WaterProductSwiper--dot"></text>
        <text class="dot WaterProductSwiper--dot"></text>
      </view>
  ...
  <view is="components/WaterProductGuess" class="r">
    <view class="caption WaterProductGuess--caption">
      <text
        class="text WaterProductGuess--text sk-transparent sk-text-0-0000-363 sk-text sk-pseudo sk-pseudo-circle"
        >猜你喜欢</text
      >
    </view>
  </view>
